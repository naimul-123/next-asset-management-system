...
const UpdateAssets = () => {
    ...
    const handleSavedata = async () => {
        ...
        try {
            ...
            // else {
            //     await postData("/api/UpdateAssets", data);
                            ...
                            <tbody>
                                {data.length > 0 && data?.map((rowData, idx) => (
                                    <tr key={idx} className="even:bg-gray-300">
                                        ...
                                        <td>{rowData.isTypeExist ? rowData.assetType : <AssetTypeInput isMissingType={missingtypesAssets.includes(rowData.assetNumber)} rowData={rowData} assetTypes={assetTypesMap.get(rowData.assetClass) || []} handleAssetTypeChange={handleAssetTypeChange} />}
                                        </td>
