...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex justify-between min-w-full h-[calc(100vh-180px)]">
      <nav className="w-60  p-4 min-h-full bg-slate-100 text-2xl space-y-2 ">
        ...
        <Link
          className={`flex items-center hover:link ${pathname === "/private/manage_user/manage_access" ? " link" : ""
            }  `}
