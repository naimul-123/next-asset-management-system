...
const DataTable = ({ tableData, assetLoading, handleRemoveAsset, updateAssetsUser, updateAssets, isEdit }) => {
    ...
    const handleAction = (e) => {
        ...
        if (action === "changeLocation") {
            ...
            const data = { department, location, loctype, assetUser, assetNumbers: selectedItems }
    ...
    return (
        ...
        <div className="print:h-fit   overflow-auto print:overflow-visible print:text-black">
                ...
                <>
                            ...
                            {isEdit &&
                                <tr className="print:hidden text-deepBlue">
                                    <th colSpan={7} className="py-4">
                                        <form className="grid grid-cols-7 text-deepBlue gap-1 items-end" onSubmit={handleAction}>
                                            <label className="form-control">
                                                <div className="label">
                                                    <span className="label-text font-bold ">Select All ({selectedItems.length})</span>
                                                </div>
                                            ...
                                            <label className="flex items-center gap-2">
                                                <button className="btn btn-xs btn-success text-white">Submit</button>
                                            </label>
                                        </form>
                                    </th>
                                </tr>
                                        ...
                                        <td>
                                            <label className="flex items-center gap-2">
                                                {isEdit && <input
                                                    ...
                                                    onChange={(e) => handleSelectItem(e.target.checked, data?.assetNumber)}
                    ...
                    <table className="table table-xs max-w-xs mx-auto print:break-before-page">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td className="text-right">Total Assets: {tableData?.assetDetails.length}</td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr className="hidden print:table-row relative bottom-0">
